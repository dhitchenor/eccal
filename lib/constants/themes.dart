...
class AppColorSchemes {
  ...
  static const yellowLight = ColorScheme(
    ...
    error: Colors.red,
    onError: Colors.white,
    background: Color(0xFFFFFCF5), // Cream
    onBackground: Colors.black,
    surface: Color(0xFFFFF8E1), // Light cream/yellow
    onSurface: Colors.black,
  ...
  static const yellowDark = ColorScheme(
    ...
    error: Colors.redAccent,
    onError: Colors.black,
    background: Color(0xFF2B2410), // Warm brown
    onBackground: Colors.white,
    surface: Color(0xFF3D3318), // Dark brown
    onSurface: Colors.white,
  ...
  static const purpleLight = ColorScheme(
    ...
    error: Colors.red,
    onError: Colors.white,
    background: Color(0xFFFAF5FC), // Pale lavender
    onBackground: Colors.black,
  ...
  static const purpleDark = ColorScheme(
    ...
    error: Colors.redAccent,
    onError: Colors.black,
    background: Color(0xFF1A0A24), // Deep violet
    onBackground: Colors.white,
    surface: Color(0xFF2C1535), // Dark purple
    onSurface: Colors.white,
  ...
  static const cyanLight = ColorScheme(
    ...
    error: Colors.red,
    onError: Colors.white,
    background: Color(0xFFF0FEFF), // Pale cyan
    onBackground: Colors.black,
    surface: Color(0xFFE0F7FA), // Light cyan
    onSurface: Colors.black,
  ...
  static const cyanDark = ColorScheme(
    ...
    error: Colors.redAccent,
    onError: Colors.black,
    background: Color(0xFF0A1F21), // Deep teal
    onBackground: Colors.white,
    surface: Color(0xFF142E30), // Dark teal
    onSurface: Colors.white,
