...
class ErrorSnackbar {
  ...
  ///
  /// This detects keyring errors and shows appropriate guidance
  ///
  /// Usage:
  /// ```dart
  /// try {
  ///   await settings.caldavPassword;
  /// } catch (e) {
  ///   if (context.mounted) {
  ///     ErrorSnackbar.showKeyringError(context, e);
  ///   }
  /// }
  /// ```
  ...
  /// Usage:
  /// ```dart
  /// final success = await ErrorSnackbar.tryAsync(
  ///   context,
  ///   () async {
  ...
  /// Usage:
  /// ```dart
  /// final success = await ErrorSnackbar.tryAsyncWithKeyring(
  ///   context,
  ///   () async {
  ///     await settings.setCaldavSettings(url, user, pass, cal);
  ///   },
  ///   successMessage: 'CalDAV settings saved',
  /// );
  /// ```
